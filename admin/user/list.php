	...
	<div class="card-header text-center">
		...
		<div class="card-tools">
			<?php if ($_settings->userdata('id') == '1') : ?>
				<a href="./?page=user/manage_user" id="create_new" class="btn btn-flat btn-primary float-right"><span class="fas fa-plus"></span> Create New</a>
			<?php else : ?>
				<a href="./?page=user/manage_user" id="create_new" class="btn btn-flat btn-primary float-right disabled"><span class="fas fa-plus"></span> Create New</a>
			<?php endif; ?>
		</div>
	</div>
	<div class="card-body">
		<div class="container-fluid">
			<table class="table table-hover table-responsive text-nowrap table-bordered" id="list">
				<colgroup>
					<col width="5%">
					<col width="15%">
					<col width="15%">
					...
					?>
						<tr>
							...
							<td align="center">
								...
								<?php else : ?>
									<button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown" disabled>
										Action
										<span class="sr-only">Toggle Dropdown</span>
									</button>
								<?php endif; ?>
