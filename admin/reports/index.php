...
?>
<div class="content py-5 px-3 text-center">
    <h2>Daily Report</h2>
</div>
        ...
        <div class="card rounded-0 mb-2 shadow">
            <div class="card-header py-1">
                <div class="card-tools">
                    <button class="btn btn-flat btn-sm btn-info border float-right" type="button" id="print"><i class="fa fa-print"></i> Print</button>
                </div>
            </div>
            <div class="card-body">
